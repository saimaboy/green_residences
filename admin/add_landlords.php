...
<head>
    ...
    <title>Admin panel-Add landlord</title>
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <h3 class="mb-4">Registered landlord List</h3>
                            ...
                            <table class="table table-hover border">
                                ...
                                <tbody>
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
                                        ...
                                        $sql = "INSERT INTO landlord (name, email, phone_number, address, date_of_birth, password)
